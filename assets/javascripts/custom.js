...
(() => {
  ...
  ***************************************************************************** */
  ...
  var Observable = function() {
    function Observable12(subscribe) {
      if (subscribe) {
        this._subscribe = subscribe;
      }
    }
    Observable12.prototype.lift = function(operator) {
      var observable2 = new Observable12();
      observable2.source = this;
      observable2.operator = operator;
      return observable2;
    };
    Observable12.prototype.subscribe = function(observerOrNext, error, complete) {
      var _this = this;
    ...
    Observable12.prototype._trySubscribe = function(sink) {
      try {
    ...
    Observable12.prototype.forEach = function(next, promiseCtor) {
      var _this = this;
    ...
    Observable12.prototype._subscribe = function(subscriber) {
      var _a;
      return (_a = this.source) === null || _a === void 0 ? void 0 : _a.subscribe(subscriber);
    };
    Observable12.prototype[observable] = function() {
      return this;
    };
    Observable12.prototype.pipe = function() {
      var operations = [];
    ...
    Observable12.prototype.toPromise = function(promiseCtor) {
      var _this = this;
      promiseCtor = getPromiseCtor(promiseCtor);
      return new promiseCtor(function(resolve, reject) {
        var value;
    ...
    Observable12.create = function(subscribe) {
      return new Observable12(subscribe);
    };
    return Observable12;
  }();
